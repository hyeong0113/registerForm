...
export class VolunteerDetail extends React.Component<IVolunteerDetailProps> {
  componentDidMount() {
  ...
  render() {
    ...
    return (
      <Row>
        <Col md="8">
          <h2>
            <Translate contentKey="registerFormApp.volunteer.detail.title">Volunteer</Translate> [<b>{volunteerEntity.id}</b>]
          </h2>
          <dl className="jh-entity-details">
            <dt>
              <span id="volunteerType">
                <Translate contentKey="registerFormApp.volunteer.volunteerType">Volunteer Type</Translate>
              </span>
            </dt>
            <dd>{volunteerEntity.volunteerType}</dd>
          </dl>
          <Button tag={Link} to="/entity/volunteer" replace color="info">
          ...
          &nbsp;
          <Button tag={Link} to={`/entity/volunteer/${volunteerEntity.id}/edit`} replace color="primary">
